...
const SubTitle = styled.h1`
  ...
  font-size: 1.95rem;
`;
const EmplasizedText = styled.strong`
  font-size: 1.6rem;
`;
  ...
  return (
    <div className="containerCenter">
      <div className="contentBlock">
        <TermsAndCondition className="regular">
          <BigHeader>Terms & Conditions</BigHeader>
          <Paragraph className="regular">
          ...
          <BigTitle>Interpretation and Definitions</BigTitle>
          ...
          <ul>
            <List>
              <EmplasizedText>Affiliate</EmplasizedText> means an entity that
            ...
            <List>
              <EmplasizedText>Company</EmplasizedText> (referred to as either
              &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
              &quot;Our&quot; in this Agreement) refers to Treact Inc., Navi
              Mumbai.
            </List>
            <List>
              <EmplasizedText>Country</EmplasizedText> refers to: Maharashtra,
              India
            </List>
            <List>
              <EmplasizedText>Service</EmplasizedText> refers to the Website.
            </List>
            <List>
              <EmplasizedText>Terms and Conditions</EmplasizedText> (also
              referred as &quot;Terms&quot;) mean these Terms and Conditions
              that form the entire agreement between You and the Company
              regarding the use of the Service.
            </List>
            <List>
              <EmplasizedText>Third-party Social Media Service</EmplasizedText>{' '}
            ...
            <List>
              <EmplasizedText>Website</EmplasizedText> refers to Treact,
              accessible from https://treact.com
            </List>
            <List>
              <EmplasizedText>You</EmplasizedText> means the individual
          ...
          <BigTitle>Acknowledgement</BigTitle>
          <Paragraph className="regular">
          ...
          <BigTitle>Links to Other Websites</BigTitle>
          <Paragraph className="regular">
          ...
          <BigTitle>Limitation of Liability</BigTitle>
          <Paragraph className="regular">
          ...
          <BigTitle>Governing Law</BigTitle>
          <Paragraph className="regular">
          ...
          <BigTitle>Disputes Resolution</BigTitle>
          <Paragraph className="regular">
          ...
          <BigTitle>For European Union (EU) Users</BigTitle>
          <Paragraph className="regular">
          ...
          <BigTitle>United States Legal Compliance</BigTitle>
          <Paragraph className="regular">
          ...
          <BigTitle>Severability and Waiver</BigTitle>
          ...
          <BigTitle>Translation Interpretation</BigTitle>
          <Paragraph className="regular">
          ...
          <BigTitle>Changes to These Terms and Conditions</BigTitle>
          <Paragraph className="regular">
          ...
          <ul>
            <List>By email: support@example.com</List>
            <List>By phone number: 408.996.1010</List>
          </ul>
        </TermsAndCondition>
      </div>
    </div>
